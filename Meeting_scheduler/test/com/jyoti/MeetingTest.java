...
import com.jyoti.MeetingBean;
import com.jyoti.CreateMeetingOutput;
import com.jyoti.BookingScheduler;
import com.jyoti.BookingMeetings;

public class MeetingTest {

	private String meetingRequest;

	private BookingScheduler meetingScheduler;
	private CreateMeetingOutput outputGenerator;

	@org.junit.Before
	public void setUp() throws Exception {
		meetingScheduler = new BookingScheduler();
		outputGenerator = new CreateMeetingOutput(new BookingScheduler());
	...
	public void shouldParseOfficeHours() {
		...
		BookingMeetings bookings = meetingScheduler.schedule(meetingRequest);
	...
	public void shouldParseMeetingRequest() {
		...
		MeetingBean meeting = bookings.getMeetings().get(meetingDate)
				.toArray(new MeetingBean[0])[0];
	...
	public void shouldGroupMeetingsChronologically() {
		...
		MeetingBean[] meetings = bookings.getMeetings().get(meetingDate)
				.toArray(new MeetingBean[0]);
